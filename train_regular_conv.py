...
if __name__ == '__main__':
    with tf.Session(config=config) as sess:
        ...
        while batch_count < validation_steps:
            ...
            acc_sum += acc
            batch_count += 1
        print('Testing for regular conv model on regular MNIST: loss={}, acc={}'.format(loss_sum / batch_count,
                                                                                        acc_sum / batch_count))
        ...
        while batch_count < validation_steps:
            ...
            acc_sum += acc
            batch_count += 1
        print('Testing for regular conv model on scaled MNIST: loss={}, acc={}'.format(loss_sum / batch_count,
                                                                                       acc_sum / batch_count))
